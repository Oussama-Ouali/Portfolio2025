...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="py-24 relative overflow-hidden bg-gradient-to-b from-slate-950 to-slate-900">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-white to-sky-200 bg-clip-text text-transparent">Get to Know Me</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-20">
          ...
          <div>
            ...
            >
              ...
              <div className="mb-10">
                <h3 className="text-2xl font-semibold mb-6 flex items-center">
                  ...
                  <span className="bg-gradient-to-r from-sky-400 to-blue-500 bg-clip-text text-transparent">My Journey</span>
                </h3>
                <div className="space-y-4 text-slate-300">
                  ...
                  <p className="leading-relaxed">
                    ...
                    with a strong emphasis on performance optimization and responsive design principles.
                  </p>
                  <p className="leading-relaxed">
                  ...
                  <p className="leading-relaxed">
                    ...
                    to approach problems methodically and create efficient, scalable solutions.
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-5">
                  ...
                  <motion.div 
                    ...
                    whileHover={{ scale: 1.02, y: -5 }}
                  >
                    <h4 className="font-semibold text-sky-300 text-lg">Bachelor's degree in Computer Science</h4>
                    <p className="text-slate-400 mt-1 flex items-center">
                      <span className="w-3 h-3 bg-sky-400 rounded-full inline-block mr-2"></span>
                  ...
                  <motion.div 
                    ...
                    whileHover={{ scale: 1.02, y: -5 }}
                  >
                    <h4 className="font-semibold text-sky-300 text-lg">AI & Data Science Program</h4>
                    <p className="text-slate-400 mt-1 flex items-center">
                      <span className="w-3 h-3 bg-sky-400 rounded-full inline-block mr-2"></span>
            ...
            <h3 className="text-2xl font-semibold mt-12 mb-8 flex items-center">
                ...
                <span className="bg-gradient-to-r from-sky-400 to-blue-500 bg-clip-text text-transparent">Languages</span>
              </h3>
            <motion.div 
              ...
              >
                <SkillCircle 
                  skill="Arabic" 
                  percentage={100}
                  icon={<span className="text-sm font-medium bg-sky-500/20 text-sky-300 px-2 py-0.5 rounded">Native</span>}
                />
                <SkillCircle 
                  skill="French" 
                  percentage={90}
                  icon={<span className="text-sm font-medium bg-sky-500/20 text-sky-300 px-2 py-0.5 rounded">Fluent</span>}
                />
                <SkillCircle 
                  skill="English" 
                  percentage={90}
                ...
                <SkillCircle 
                  skill="German" 
                  percentage={40}
                  icon={<span className="text-sm font-medium bg-sky-500/20 text-sky-300 px-2 py-0.5 rounded">Basic</span>}
                />
              </motion.div>
          </div>
          ...
          <div>
            ...
            >
              <h3 className="text-2xl font-semibold mb-8 flex items-center">
                ...
                <span className="bg-gradient-to-r from-sky-400 to-blue-500 bg-clip-text text-transparent">Technical Skills</span>
              </h3>
              ...
              <h3 className="text-2xl font-semibold mb-8 flex items-center">
                ...
                <span className="bg-gradient-to-r from-sky-400 to-blue-500 bg-clip-text text-transparent">Specializations</span>
              </h3>
                ...
                {specializations.map((spec, index) => (
                  ...
                  >
                    <div className="flex items-center mb-3">
                      ...
                      <h4 className="font-medium text-lg text-sky-200">{spec.title}</h4>
                    </div>
